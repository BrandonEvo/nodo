        ...
        <div className="w-full max-w-[440px] transition-all duration-500">
          ...
          {view === 'forgot' && (
            <div className="w-full animate-in fade-in slide-in-from-left-4 duration-300">
              ...
              <p className="text-sm text-gray-500 font-medium mb-8">Selecciona cómo iniciaste sesión para continuar.</p>

              <div className="space-y-4">
                {/* Opción Google */}
                <div className="rounded-2xl border-2 border-gray-200 p-5 space-y-3">
                  <p className="text-sm font-bold text-[#111111]">¿Usas Google para ingresar?</p>
                  <p className="text-xs text-gray-400">Tu contraseña la gestiona Google. Inicia sesión con el botón de Google o restablécela desde tu cuenta Google.</p>
                  <Button
                    type="button"
                    onClick={() => window.open('https://myaccount.google.com/security', '_blank')}
                    className="w-full h-12 bg-white hover:bg-gray-50 text-[#111111] border-2 border-gray-200 font-bold text-sm rounded-xl shadow-sm transition-transform active:scale-[0.98] flex items-center justify-center gap-3"
                  >
                ...
                {/* Opción cuenta propia */}
                <div className="rounded-2xl border-2 border-gray-200 p-5 space-y-3">
                  <p className="text-sm font-bold text-[#111111]">¿Creaste una cuenta con correo y contraseña?</p>
                  <p className="text-xs text-gray-400">La recuperación de contraseña por correo estará disponible próximamente. Por ahora, contacta al administrador de tu empresa.</p>
                  <div className="flex items-center gap-2 bg-amber-50 border border-amber-200 rounded-xl px-4 py-3">
                    <span className="text-amber-600 text-xs font-bold">⏳ Próximamente disponible</span>
                  </div>
                </div>
              </div>
